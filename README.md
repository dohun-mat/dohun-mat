...
● [KCC2024]BiFPN의 적용으로 RetinaFace모델의 얼굴인식 문제 해결 및 BiRetina 개발 - [BiFPN의 적용으로 RetinaFace 모델의 얼굴인식 문제 해결 및 BiRetina 개발](https://github.com/dohun-mat/BiRetina)  
● [Electronics 2025]FeatherFace: Robust and Lightweight Face Detection via Optimal Feature Integration - [FeatherFace: Robust and Lightweight Face Detection via Optimal Feature Integration](https://github.com/dohun-mat/FeatherFace)  
● [ACCV 2026]WeaveMambaFusion: Global Cross-Scale Interaction for Lightweight Face Detection](https://github.com/dohun-mat/WeaveMambaFusion)  
...
●Mimic4 데이터로 중환자 사망자 예측 모델 제작 - [Mimic4 데이터로 중환자 사망자 예측 모델 제작 git 링크](https://github.com/dohun-mat/mimic_iv_project)  
